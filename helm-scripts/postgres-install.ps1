...
helm install $name bitnami/postgresql --set global.postgresql.auth.username=root --set global.postgresql.auth.password=root --set global.postgresql.auth.database=test
